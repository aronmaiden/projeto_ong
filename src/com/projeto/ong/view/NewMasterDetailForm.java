...
public class NewMasterDetailForm extends JPanel {
    ...
    private void initComponents() {
        ...
        entityManager = java.beans.Beans.isDesignTime() ? null : javax.persistence.Persistence.createEntityManagerFactory("projeto_ong?zeroDateTimeBehavior=convertToNullPU").createEntityManager();
        query = java.beans.Beans.isDesignTime() ? null : entityManager.createQuery("SELECT d FROM Doacao d");
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        List<com.projeto.ong.entity.Doacao> toRemove = new ArrayList<com.projeto.ong.entity.Doacao>(selected.length);
        for (int idx = 0; idx < selected.length; idx++) {
            com.projeto.ong.entity.Doacao d = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(d);
    ...
    private void newButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newButtonActionPerformed
        com.projeto.ong.entity.Doacao d = new com.projeto.ong.entity.Doacao();
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        try {
            ...
            rex.printStackTrace();
            entityManager.getTransaction().begin();
            List<com.projeto.ong.entity.Doacao> merged = new ArrayList<com.projeto.ong.entity.Doacao>(list.size());
            for (com.projeto.ong.entity.Doacao d : list) {
    ...
    private java.util.List<com.projeto.ong.entity.Doacao> list;
